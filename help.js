...
!прах [id пользователя](для админов) - просмотр имеющегося праха в запасе

!взять [id пользователя](для админов) [тип предмета] [название]
...
!выбросить(или выкинуть) [номер предмета в инвентаре] [id пользователя](для админов) - удалить предмет из своего инвентаря. Он будет автоматически снят с вас.`;
          break;
        default:
