...
export declare type VKAppPayloadContextType = 'vk_app_event';
export declare type VKAppPayloadContextSubType = 'app_payload';
...
export declare type VKAppPayloadContextOptions<S> = ContextFactoryOptions<IVKAppPayloadPayload, S>;
